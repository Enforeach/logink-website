...
import { getServiceBySlug } from '@/payload/queries'
...
const SERVICES_ID = {
  'seo-content-marketing': {
    ...
    process: [
      ...
      { step: '02', title: 'Strategi Konten', desc: 'Peta topical cluster dan kalender editorial yang dirancang untuk funnel Anda.', duration: 'Minggu 2' },
  ...
  'social-media-management': {
    ...
    process: [
      { step: '01', title: 'Brand Onboarding', desc: 'Kami mempelajari tone, audiens, kompetitor, dan identitas visual Anda.', duration: 'Minggu 1' },
      ...
      { step: '04', title: 'Persetujuan & Penjadwalan', desc: 'Anda meninjau kalender dan menyetujuinya sebelum kami jadwalkan.', duration: 'Minggu 3–4' },
    ],
    stats: [
  ...
  'paid-advertising': {
    ...
    faqs: [
      { question: 'Platform iklan apa saja yang Logink kelola?', answer: 'Google Ads (Search, Display, Shopping), Meta Ads (Facebook & Instagram), TikTok Ads, dan Marketplace Ads.' },
      ...
      { question: 'Apakah saya memiliki akses ke akun iklan sendiri?', answer: 'Ya, 100%. Kami mengelola langsung di dalam akun milik Anda, dengan akses penuh tetap berada di tangan Anda setiap saat.' },
  ...
  'creative-services': {
    ...
    process: [
      ...
      { step: '02', title: 'Konsep & Moodboard', desc: 'Konsep awal dan arahan dipresentasikan untuk persetujuan Anda.', duration: 'Hari 3–5' },
  ...
  'website-landing-page': {
    ...
    process: [
      ...
      { step: '02', title: 'Wireframe & Desain', desc: 'Prototipe Figma lengkap (desktop dan mobile) untuk persetujuan Anda.', duration: '5–7 hari' },
    ...
    faqs: [
      ...
      { question: 'Apakah pelatihan termasuk?', answer: 'Ya: sesi pelatihan dan dokumentasi untuk tim Anda setelah launch.' },
    ],
  },
}
...
const UI_COPY = {
  id: {
    ...
    featuresDesc: 'Tidak ada biaya tersembunyi. Semua yang dibutuhkan brand Anda untuk berkembang, dalam satu atap.',
    processLabel: 'Cara Kerjanya',
    processHeadline: 'Dari kickoff hingga hasil.',
    processDesc: 'Proses yang jelas dan terstruktur agar Anda selalu tahu langkah selanjutnya.',
    pricingLabel: 'Harga',
    pricingHeadline: 'Pilih paket yang sesuai.',
    pricingDesc: 'Harga transparan, tanpa kejutan, disesuaikan dengan tujuan Anda.',
    faqLabel: 'FAQ',
