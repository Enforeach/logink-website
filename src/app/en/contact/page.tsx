          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-[var(--border-default)] bg-[var(--bg-surface)] hover:border-emerald-500/40 group transition-all">
                ...
                <a href={`mailto:${SITE.email}`} className="flex items-center gap-4 p-4 rounded-xl border border-[var(--border-default)] bg-[var(--bg-surface)] hover:border-brand-violet/40 group transition-all">
