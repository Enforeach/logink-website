  ...
  if (value === true) {
    return (
      <div className="flex justify-center">
        <svg className="h-5 w-5" viewBox="0 0 20 20" fill="#A855F7" aria-hidden>
    ...
    <div className="mt-10">
      <div className="text-center mb-4">
        <button
          onClick={() => setOpen((o) => !o)}
          aria-expanded={open}
          className="inline-flex items-center gap-2 text-sm font-semibold transition-opacity hover:opacity-70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A855F7] rounded-full px-3 py-1.5"
          style={{ color: '#9333EA' }}
        >
          {toggleLabel}
          <motion.svg
              ...
              <table className="w-full min-w-[560px]">
                <thead>
                  <tr>
                    ...
                    <th className="sticky top-0 z-10 px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider bg-[var(--bg-tint-lilac)] border-b border-[var(--border-default)]" style={{ color: '#9333EA' }}>Entry</th>
                    <th className="sticky top-0 z-10 px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider bg-[var(--bg-tint-lilac)] border-b border-[var(--border-default)]" style={{ color: '#9333EA' }}>Growth</th>
                    <th className="sticky top-0 z-10 px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider bg-[var(--bg-tint-lilac)] border-b border-[var(--border-default)]" style={{ color: '#C2410C' }}>Full</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <Fragment key={`cat-${ci}`}>
                      <tr>
                        <td
                          ...
                          style={{ color: '#9333EA', background: 'rgba(168,85,247,0.05)' }}
                        >
                          {cat.name}
                        </td>
                      </tr>
