    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="text-center mb-12">
          <p className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)] mb-3">{copy.eyebrow}</p>
        ...
        >
          <div className="rounded-2xl bg-[var(--bg-surface)] px-8 py-7 text-center">
            <p className="text-sm text-[var(--text-muted)] mb-2">{copy.pricingNote}</p>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h3 className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)] mb-5">{copy.addonsTitle}</h3>
