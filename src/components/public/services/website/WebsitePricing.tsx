...
const WA_MESSAGE = encodeURIComponent(
  "Hi Logink, I'm interested in a website project. Can we schedule a Discovery call?"
)
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="text-center mb-12">
          <p className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)] mb-3">Scope & Pricing</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[var(--text-primary)]">
            Transparent scope. Custom pricing.
          </h2>
        </div>
        ...
        >
          <div className="rounded-2xl bg-[var(--bg-surface)] px-8 py-7 text-center">
            <p className="text-sm text-[var(--text-muted)] mb-2">All web projects</p>
            ...
            <p className="text-sm text-[var(--text-secondary)] max-w-lg mx-auto leading-relaxed">
              Final pricing is based on page count, complexity, integrations, and custom functionality. We provide a detailed scope and quote after a free Discovery call — no commitment required.
            </p>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-sm font-bold text-[var(--text-secondary)] mb-5">
            What's included in each project type:
          </h3>
          <WebsiteScopeTable />
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h3 className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)] mb-5">Add-ons</h3>
        ...
        >
          ...
          <p className="mt-3 text-xs text-[var(--text-muted)]">
            Free Discovery call. Detailed proposal within 48 hours.
          </p>
        </motion.div>
      </div>
    </section>
