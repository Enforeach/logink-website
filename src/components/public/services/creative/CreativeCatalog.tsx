...
const CATALOG_COPY = {
  id: { eyebrow: 'Jasa Desain & Video', heading: 'Tiga studio, satu tim kreatif.', sub: 'Setiap deliverable dibuat kustom untuk brand Anda, tanpa template, tanpa stock, tanpa jalan pintas.' },
  en: { eyebrow: 'Design & Video Services', heading: 'Three studios, one creative team.', sub: 'Every deliverable is custom-made for your brand: no templates, no stock, no shortcuts.' },
}
